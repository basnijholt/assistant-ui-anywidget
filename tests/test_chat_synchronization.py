...
class TestChatHistorySynchronization:
    ...
    def test_add_message_python_api(self):
    ...
    def test_ui_message_no_auto_response(self):
    ...
    def test_multiple_ui_messages(self):
    ...
    def test_mixed_message_sources(self):
    ...
    def test_clear_after_messages(self):
...
class TestUISimulation:
    ...
    def test_ui_simulation_single_message(self):
    ...
    def test_ui_simulation_multiple_messages(self):
    ...
    def test_ui_simulation_with_existing_history(self):
    ...
    def test_ui_simulation_after_clear(self):
