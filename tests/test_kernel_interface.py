...
class MockIPython:
    ...
    def _create_mock_dataframe(self) -> Mock:
    ...
    def _create_mock_array(self) -> Mock:
        ...
        mock_arr.__repr__ = Mock(return_value="array(shape=(10, 20), dtype=float64)")  # type: ignore[method-assign]
        return mock_arr
    ...
    def _get_exc_info(self) -> tuple[type, Exception, None]:
        """Mock for getting exception info."""
        if self._last_error:
            return (type(self._last_error), self._last_error, None)  # type: ignore[unreachable]
        return (None, None, None)  # type: ignore[return-value]


@pytest.fixture  # type: ignore[misc]
def mock_ipython() -> MockIPython:
    """Create a mock IPython instance."""
    return MockIPython()


@pytest.fixture  # type: ignore[misc]
def kernel_interface(mock_ipython: MockIPython) -> KernelInterface:
...
class TestKernelInterface:
    ...
    def test_is_available(self, kernel_interface: KernelInterface) -> None:
    ...
    def test_get_namespace(self, kernel_interface: KernelInterface) -> None:
    ...
    def test_get_variable_info(self, kernel_interface: KernelInterface) -> None:
    ...
    def test_execute_code_success(self, kernel_interface: KernelInterface) -> None:
    ...
    def test_execute_code_error(self, kernel_interface: KernelInterface) -> None:
    ...
    def test_get_last_error(self, kernel_interface: KernelInterface) -> None:
    ...
    def test_get_stack_trace(self, kernel_interface: KernelInterface) -> None:
    ...
    def test_get_kernel_info(self, kernel_interface: KernelInterface) -> None:
    ...
    def test_preview_generation(self, kernel_interface: KernelInterface) -> None:
        """Test preview generation for different types."""
        # Test long string preview
        assert kernel_interface.shell is not None
        ...
        assert kernel_interface.shell is not None
        assert kernel_interface.shell.user_ns is not None
    ...
    def test_variable_info_to_dict(self) -> None:
...
class TestKernelInterfaceWithoutIPython:
    ...
    def test_without_ipython(self) -> None:
