...
_global_agent: Optional[EnhancedAgentWidget] = None
...
def get_agent(
    ...
    **kwargs: Any
    ...
    Args:
        ...
        **kwargs: Additional arguments passed to EnhancedAgentWidget
    
    Returns:
        EnhancedAgentWidget: The global agent instance
    ...
    with _agent_lock:
        if _global_agent is None or reset:
            ...
            # Create new instance
            _global_agent = EnhancedAgentWidget(
...
def get_agent_info() -> Dict[str, Any]:
    ...
    try:
        return {
            ...
            'log_path': str(_global_agent.get_conversation_log_path()) if hasattr(_global_agent, 'get_conversation_log_path') else None,
        }
    except Exception:
...
def display_agent() -> EnhancedAgentWidget:
    ...
    Returns:
        EnhancedAgentWidget: The agent instance (displayed when returned)
...
def _deprecated_widget_warning() -> None:
    ...
    warnings.warn(
        "Creating EnhancedAgentWidget directly is discouraged in notebooks. "
