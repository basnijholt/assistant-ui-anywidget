...
class TestWidgetBasics:
    ...
    def test_esm_content_loaded(self, widget):
...
class TestMessageAPI:
    ...
    def test_add_message_user(self, widget):
    ...
    def test_add_message_assistant(self, widget):
    ...
    def test_add_multiple_messages(self, widget):
...
class TestUIMessageHandling:
    ...
    def test_handle_user_message(self, widget, ui_message_factory):
    ...
    def test_handle_invalid_message_type(self, widget):
    ...
    def test_handle_empty_message(self, widget, ui_message_factory):
    ...
    def test_handle_message_no_auto_response(self, widget, ui_message_factory):
